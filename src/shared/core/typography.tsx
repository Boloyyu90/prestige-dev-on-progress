...
const headingVariants = cva(
  "font-display font-bold tracking-tight",
  {
    variants: {
      ...
      size: {
        "display-2xl": "text-4xl md:text-5xl lg:text-6xl xl:text-7xl",
        "display-xl": "text-3xl md:text-4xl lg:text-5xl xl:text-6xl",
        "display-lg": "text-2xl md:text-3xl lg:text-4xl xl:text-5xl",
        "display-md": "text-xl md:text-2xl lg:text-3xl xl:text-4xl",
        "display-sm": "text-lg md:text-xl lg:text-2xl xl:text-3xl",
  ...
  ({
    ...
    return (
      <MotionComponent
        ...
        className={cn(
          headingVariants({ variant, size, weight, align }),
          animationType === 'typewriter' && 'overflow-hidden whitespace-nowrap',
          className
        )}
